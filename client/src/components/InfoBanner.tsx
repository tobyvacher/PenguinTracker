        ...
        <div className="flex items-center flex-1">
          ...
          <div className="ml-4">
            ...
            <div className="mt-1 text-sm">
              <p>Tap a penguin to learn more and log your sightings. Use the <strong>👁</strong> eye icon to mark it as seen or unseen. Your progress is saved locally — sign in to keep it permanently across devices. Welcome to Penguin Tracker!</p>
            </div>
          </div>
        </div>
        <button 
